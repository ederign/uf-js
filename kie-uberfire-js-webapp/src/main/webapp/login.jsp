  ...
  <style type="text/css">
    * {
    ...
    body {
      ...
      padding: 0;
      color: #fff;
      background: url('org.uberfire.KieUberfireJS/images/bg-login.png') repeat #1b1b1b;
      font-size: 14px;
    ...
    #dummy {
      ...
      height: 250px;
      width: 100%;
      background: url('org.uberfire.KieUberfireJS/images/bg-login-top.png') repeat #fff;
      z-index: 1;
    }
...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <img src="org.uberfire.KieUberfireJS/images/uf_logo.tpng" alt="UberFire Logo" title="Powered By Uberfire"/>
  </div>
