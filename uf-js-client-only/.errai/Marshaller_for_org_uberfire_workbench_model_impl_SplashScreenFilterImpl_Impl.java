...
public class Marshaller_for_org_uberfire_workbench_model_impl_SplashScreenFilterImpl_Impl implements GeneratedMarshaller<SplashScreenFilterImpl> {
  ...
  public SplashScreenFilterImpl demarshall(EJValue a0, MarshallingSession a1) {
    ...
    SplashScreenFilterImpl entity = new SplashScreenFilterImpl();
    ...
    if ((obj.containsKey("interceptionPoints")) && (!obj.get("interceptionPoints").isNull())) {
      entity.setInterceptionPoints((Collection) ((ObjectMarshaller) java_lang_Object).demarshall(Collection.class, obj.get("interceptionPoints"), a1));
    }
    return entity;
  }
