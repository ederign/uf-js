...
public class WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Panel, org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView>, org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView.WorkbenchToolBarViewBinder {
  ...
  public com.google.gwt.user.client.ui.Panel createAndBindUi(final org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView owner) {
   ...
   */
  class Widgets {
    private final org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView owner;
    ...
    public Widgets(final org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView owner) {
      this.owner = owner;
     ...
     */
    private org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenBundle) GWT.create(org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenCss_style style;
    private org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenCss_style get_style() {
      return style;
    }
    private org.uberfire.client.workbench.widgets.toolbar.WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.FlowPanel build_masterContainer() {
      ...
      owner.masterContainer = masterContainer;
     ...
     */
    private com.github.gwtbootstrap.client.ui.ButtonToolbar get_toolBar() {
      return build_toolBar();
    }
    private com.github.gwtbootstrap.client.ui.ButtonToolbar build_toolBar() {
      // Creation section.
      final com.github.gwtbootstrap.client.ui.ButtonToolbar toolBar = (com.github.gwtbootstrap.client.ui.ButtonToolbar) GWT.create(com.github.gwtbootstrap.client.ui.ButtonToolbar.class);
      // Setup section.
     ...
     */
    private com.github.gwtbootstrap.client.ui.Tooltip get_tip() {
      return build_tip();
    }
    private com.github.gwtbootstrap.client.ui.Tooltip build_tip() {
      // Creation section.
      final com.github.gwtbootstrap.client.ui.Tooltip tip = (com.github.gwtbootstrap.client.ui.Tooltip) GWT.create(com.github.gwtbootstrap.client.ui.Tooltip.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.SimplePanel build_simpleMargin() {
      ...
      owner.simpleMargin = simpleMargin;
