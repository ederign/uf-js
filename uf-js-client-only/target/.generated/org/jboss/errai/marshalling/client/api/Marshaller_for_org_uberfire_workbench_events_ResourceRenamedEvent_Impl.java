...
public class Marshaller_for_org_uberfire_workbench_events_ResourceRenamedEvent_Impl implements GeneratedMarshaller<ResourceRenamedEvent> {
  ...
  private native static SessionInfo _$1239515980__291376327_sessionInfo(ResourceRenamedEvent instance) /*-{
    return instance.@org.uberfire.workbench.events.ResourceRenamedEvent::sessionInfo;
  }-*/;

  private native static void _$1239515980__291376327_sessionInfo(ResourceRenamedEvent instance, SessionInfo value) /*-{
    instance.@org.uberfire.workbench.events.ResourceRenamedEvent::sessionInfo = value;
  }-*/;
  ...
  public ResourceRenamedEvent demarshall(EJValue a0, MarshallingSession a1) {
    ...
    ResourceRenamedEvent entity = new ResourceRenamedEvent();
    ...
    if ((obj.containsKey("sessionInfo")) && (!obj.get("sessionInfo").isNull())) {
      _$1239515980__291376327_sessionInfo(entity, org_uberfire_rpc_SessionInfo.demarshall(obj.get("sessionInfo"), a1));
    }
