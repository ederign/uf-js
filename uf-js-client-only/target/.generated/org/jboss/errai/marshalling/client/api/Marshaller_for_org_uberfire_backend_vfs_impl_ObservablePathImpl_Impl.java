...
public class Marshaller_for_org_uberfire_backend_vfs_impl_ObservablePathImpl_Impl implements GeneratedMarshaller<ObservablePathImpl> {
  ...
  private native static Path _$1304194947__$2084529122_original(ObservablePathImpl instance) /*-{
    return instance.@org.uberfire.backend.vfs.impl.ObservablePathImpl::original;
  }-*/;

  private native static void _$1304194947__$2084529122_original(ObservablePathImpl instance, Path value) /*-{
    instance.@org.uberfire.backend.vfs.impl.ObservablePathImpl::original = value;
  }-*/;
  ...
  public ObservablePathImpl demarshall(EJValue a0, MarshallingSession a1) {
    ...
    if ((obj.containsKey("original")) && (!obj.get("original").isNull())) {
      _$1304194947__$2084529122_original(entity, (Path) ((ObjectMarshaller) java_lang_Object).demarshall(Path.class, obj.get("original"), a1));
    }
    return entity;
  }
  ...
  public String marshall(ObservablePathImpl a0, MarshallingSession a1) {
    ...
    return json.append(",").append("\"path\":").append(java_lang_Object.marshall(_$1304194947__$2084529122_path(a0), a1)).append(",").append("\"original\":").append(java_lang_Object.marshall(_$1304194947__$2084529122_original(a0), a1)).append("}").toString();
  }
